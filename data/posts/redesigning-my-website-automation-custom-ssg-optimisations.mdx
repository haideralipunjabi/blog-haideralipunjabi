---
date: '2020-08-02'
summary: I recently decided to redesign my website, and went all out on it. I made a small python script to act as a Static Site Generator and optimised it to the extreme.
...
2. backpack.json, foss-contributions.json, timeline.json, projects.json  
   ...
   _backpack.json_
   <Github repo="haideralipunjabi/portfolio-v2" file="data/backpack.json" lang="json" subLines="3-6" showLineNumbers={true}/>

   _foss-contributions.json_
   <Github repo="haideralipunjabi/portfolio-v2" file="data/foss-contributions.json" lang="json" subLines="3-6" showLineNumbers={true}/>

   _timeline.json_
   <Github repo="haideralipunjabi/portfolio-v2" file="data/timeline.json" lang="json" subLines="3-7" showLineNumbers={true}/>

   _projects.json_
   <Github repo="haideralipunjabi/portfolio-v2" file="data/projects.json" lang="json" subLines="3-17" showLineNumbers={true}/>
...
<Github repo="haideralipunjabi/portfolio-v2" file=".travis/build.py" lang="python" subLines="33-63" showLineNumbers={true}/>
...
<Github repo="haideralipunjabi/portfolio-v2" file=".travis/build.py" lang="python" subLines="18-29" showLineNumbers={true}/>
