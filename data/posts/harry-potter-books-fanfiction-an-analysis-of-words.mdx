---
date: '2020-06-01'
summary: Graphs and WordCloud based analysis of Most Occurring Words in Harry Potter Books and popular Fanfiction Stories
...
<Github repo="haideralipunjabi/harrypotter-analysis" file="scrape_fanfics.py" lang="python" showLineNumbers={true} />
...
<Github repo="haideralipunjabi/harrypotter-analysis" file="text_to_json.py" lang="python" showLineNumbers={true} /> 
...
<Github repo="haideralipunjabi/harrypotter-analysis" file="make_wordcloud.py" lang="python" showLineNumbers={true}/>
...
<Github repo="haideralipunjabi/harrypotter-analysis" file="make_graph.py" lang="python" showLineNumbers={true} />
